        ...
        <>
            <div className="container">
                    ...
                    <div className="first_line">
                        <div className="title_name">
                            ...
                            <div>
                                ...
                                <button className="submit newSubmit" onClick={() => {
                                    SearchByTitle().then()
                                }
                                }>Submit</button>
                            </div>
                ...
                <div className="data" style={{marginTop: "30px"}}>
                    {data.map((newItem: any) => {
                        return (
                            <div className="bookmark_element" key={newItem.id}>
                                <div className="bookmark_info">
                                    <div className="top">

                                        <div className="left">
                                            <div className="bookmark_name">{newItem.title}</div>
                                        </div>

                                        <div className="right">
                                            {newItem.tags.map((tag: string) => (
                                    ...
                                    <div className="bottom">
                                        <a className="bookmark_URL" href={newItem.url}> {newItem.url}</a>
                                    </div>
                                </div>
                                <button className="delete_button" onClick={deleteDataById.bind(this, newItem.id)}>X</button>
                            </div>
                        )
                    })}
                </div>
